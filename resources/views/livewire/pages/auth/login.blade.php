...
<div class="w-full">
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-500">Choose your category to access tailored features and resources</p>
    </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <label class="cursor-pointer relative">
                    ...
                    <div class="p-4 rounded-lg border-2 border-gray-300 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-gray-400 transition-all flex items-center justify-center gap-2">
                        ...
                        <span class="font-medium text-gray-700">I'm a Student</span>
                    </div>
                ...
                <label class="cursor-pointer relative">
                    ...
                    <div class="p-4 rounded-lg border-2 border-gray-300 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-gray-400 transition-all flex items-center justify-center gap-2">
                        ...
                        <span class="font-medium text-gray-700">I'm a Staff</span>
                    </div>
                    <div class="absolute top-3 right-3 w-5 h-5 rounded-full border-2 border-gray-300 peer-checked:border-blue-500 peer-checked:bg-blue-500 flex items-center justify-center transition-all">
                        <div class="w-2 h-2 rounded-full bg-white opacity-0 peer-checked:opacity-100"></div>
                    </div>
